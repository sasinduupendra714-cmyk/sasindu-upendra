...
export default function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <div className="hidden md:flex flex-col w-64 bg-black border-r border-white/10 h-full p-4 shrink-0">
          ...
          <div className="bg-white/5 rounded-xl p-4">
            ...
            <div className="space-y-3">
              {['Combined Maths', 'Physics', 'Chemistry'].map((subject) => (
                <div key={subject} className="flex items-center gap-3 group cursor-pointer">
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-black/80 backdrop-blur-lg border-t border-white/10 px-2 py-1 flex items-center justify-around z-[60] pb-safe">
